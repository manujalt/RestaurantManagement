...
namespace RestaurantManagementSystems.Areas.PayrollSystem.Controllers
{
    ...
    public class DepartmentsController : Controller
    {
        ...
        // GET: PayrollSystem/Departments
        public async Task<IActionResult> Index()
        {
            return View(await _context.Department.ToListAsync());
        }

        // GET: PayrollSystem/Departments/Details/5
        ...
        // GET: PayrollSystem/Departments/Create
        public IActionResult Create()
        {
            return View();
        }

        // POST: PayrollSystem/Departments/Create
        ...
        // GET: PayrollSystem/Departments/Edit/5
        ...
        // POST: PayrollSystem/Departments/Edit/5
        // To protect from overposting attacks, please enable the specific properties you want to bind to, for 
        // more details see http://go.microsoft.com/fwlink/?LinkId=317598.
        [HttpPost]
        [ValidateAntiForgeryToken]
        ...
        // GET: PayrollSystem/Departments/Delete/5
        ...
        // POST: PayrollSystem/Departments/Delete/5
